module.exports = {
  '@primary-color': '#f8ccdc',
  '@success-color': '#66ab8c',
  '@info-color': '#ffffff',
  '@warning-color': '#f5222d',
  '@error-color': '#f5222d',
  '@processing-color': '@primary-color',
  '@heading-color': '#fa7c92',
  '@text-color': 'fade(#000, 65%)',
  '@text-color-secondary': 'fade(#000, 45%)',
  '@border-color-base': '#9b89b3',
  '@border-color-split': '#d7d4db',
  '@border-width-base': '2px',
  '@layout-body-background': '#fff7c0',
  '@layout-header-background': '#cae4db',
  '@layout-trigger-background': '#5867ff',
  '@font-size-base': '18px',
  '@font-size-sm': '14px',
  ...
  '@input-placeholder-color': '#f4f4f4',
  '@input-hover-border-color': '#737373',
  '@progress-radius': '0',
  '@menu-dark-arrow-color': '#ffffff',
  '@menu-dark-submenu-bg': '#88bbd6',
  '@menu-dark-highlight-color': '#b39cd0',
  ...
  '@page-header-padding-horizontal': '26px',
